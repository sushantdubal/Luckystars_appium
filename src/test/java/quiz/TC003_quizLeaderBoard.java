...
public class TC003_quizLeaderBoard extends basek {
	...
	public void signIn() throws InterruptedException {
		...
		test = report
				.startTest("Quiz - Verify participation in leaderBoard working");
		test.log(LogStatus.INFO, "Lucky Stars application is up and running");
		test.log(LogStatus.INFO, "User on Leaderboard screen");
	...
	public void leaderBoard() throws InterruptedException {
		...
		driver.findElement(By.id("in.interactive.luckystars:id/tv_view_all")).click();
