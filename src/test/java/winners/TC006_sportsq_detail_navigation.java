...
@Test public class TC006_sportsq_detail_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void sportsq_detail_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to sportsq detail screen");
		...
		String expected_text ="PRIZE POOLS";	
		String actual_text=driver.findElement(By.id("in.interactive.luckystars:id/tv_prizes_section")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to sportsq detail screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to sportsq detail screen");
