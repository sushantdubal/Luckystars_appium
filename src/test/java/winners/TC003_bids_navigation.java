...
@Test public class TC003_bids_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void bids_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to bids screen");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to bids screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to bids screen");
