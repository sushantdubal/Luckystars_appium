...
@Test public class TC001_quizzes_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	{
		test = report.startTest("Home: Verify navigation to quizzes screen");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to quizzes screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to quizzes screen");
