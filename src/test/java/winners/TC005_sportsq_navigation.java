...
@Test public class TC005_sportsq_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void sportsq_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to sportsq screen");
		...
		String expected_text ="SportsQ";	
		String actual_text=driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[1]/android.view.ViewGroup/android.widget.HorizontalScrollView/android.widget.LinearLayout/android.support.v7.app.ActionBar.Tab[3]/android.widget.TextView")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to sportsq screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to sportsq screen");
