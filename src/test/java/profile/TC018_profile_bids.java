...
@Test public class TC018_profile_bids extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_bids_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to bids detail");
		...
		driver.findElement(By.id("ll_participated_bid")).click();	
		String expected_text ="Bids";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to bids detail");
