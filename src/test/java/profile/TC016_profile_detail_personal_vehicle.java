...
@Test public class TC016_profile_detail_personal_vehicle extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_personal_vehicle_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify profile detail- Personal Vehicle");
		...
		driver.findElement(By.id("et_personal_vehicle")).click();	
		String expected_text ="2 Wheeler";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify profile detail- Personal Vehicle");
