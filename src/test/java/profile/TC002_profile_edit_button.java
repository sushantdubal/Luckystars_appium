...
@Test public class TC002_profile_edit_button extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@BeforeMethod
	@Test()
	public void profile_edit_button_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify click on edit button");
