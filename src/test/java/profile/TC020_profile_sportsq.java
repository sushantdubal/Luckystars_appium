...
@Test public class TC020_profile_sportsq extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_sportsq_test() throws InterruptedException 
	{
		...
		driver.findElement(By.id("tv_sport_quizzes")).click();	
