...
@Test public class TC008_profile_valid_birthdate extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_valid_birthdate_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify valid birthdate");
		...
		String expected_text ="5/6/2000";	
		String actual_text=driver.findElement(By.id("et_date_of_birth")).getText();
...
*/
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify valid birthdate");
