...
@Test public class TC004_profile_detail_camera extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_camera_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify profile pic edit option- Camera");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify profile pic edit option- Camera");
