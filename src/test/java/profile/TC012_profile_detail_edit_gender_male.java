...
@Test public class TC012_profile_detail_edit_gender_male extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_edit_gender_male_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify gender- Male");
		...
		driver.findElement(By.id("rb_male")).click();	
		String expected_text ="Male";	
		String actual_text=driver.findElement(By.id("rb_male")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify gender- Male");
