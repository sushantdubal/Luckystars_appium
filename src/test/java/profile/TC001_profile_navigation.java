...
@Test public class TC001_profile_navigation extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@BeforeMethod
	@Test()
	public void profile_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to profile screen");
