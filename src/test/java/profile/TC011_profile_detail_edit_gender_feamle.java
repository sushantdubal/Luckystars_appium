...
@Test public class TC011_profile_detail_edit_gender_feamle extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_edit_gender_feamle_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify gender- Female");
		...
		//Hide Keyboard
		driver.navigate().back();
		driver.scrollToExact("Gender");
		driver.findElement(By.id("rb_female")).click();	
		String expected_text ="Female";	
		String actual_text=driver.findElement(By.id("rb_female")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify gender- Female");
