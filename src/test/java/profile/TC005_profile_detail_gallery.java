...
@Test public class TC005_profile_detail_gallery extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_gallery_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify profile ecit option- Gallery");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify profile ecit option- Gallery");
