...
@Test public class TC023_profile_faq extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_faq_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to FAQs");
		...
		driver.findElement(By.id("tv_faq")).click();	
		String expected_text ="FAQs";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to FAQs");
