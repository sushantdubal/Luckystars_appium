...
@Test public class TC024_profile_feedback extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_feedback_test() throws InterruptedException 
	{
		...
		driver.findElement(By.id("tv_feedback")).click();	
		String expected_text ="Feedback / Support";	
