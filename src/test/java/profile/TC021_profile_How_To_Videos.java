...
@Test public class TC021_profile_How_To_Videos extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_How_To_Videos_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to How_to-videos");
		...
		driver.findElement(By.id("tv_video")).click();	
		String expected_text ="How-To Videos";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to How_to-videos");
