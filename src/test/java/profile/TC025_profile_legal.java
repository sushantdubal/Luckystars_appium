...
@Test public class TC025_profile_legal extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_legal_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to feedback");
		...
		//wait time 10 seconds
		 Thread.sleep(10000);
		 driver.scrollToExact("Rate Us");	
		//wait time 10 seconds
		 Thread.sleep(10000);
		driver.findElement(By.id("tv_legal")).click();
		
		String expected_text ="Legal";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to feedback");
