...
@Test public class TC017_profile_quizzes extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_quizzes_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to quizzes detail");
		...
		driver.findElement(By.id("tv_trivia_played")).click();	
		String expected_text ="Quizzes";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to quizzes detail");
