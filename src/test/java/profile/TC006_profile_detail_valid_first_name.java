...
@Test public class TC006_profile_detail_valid_first_name extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_valid_first_name_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify valid first name");
		...
		driver.findElement(By.xpath("//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/"
				...
				+ "android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]")).click();
		...
		String expected_text ="Sushant";	
		String actual_text=driver.findElement(By.id("et_first_name")).getText();
...
*/
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify valid first name");
