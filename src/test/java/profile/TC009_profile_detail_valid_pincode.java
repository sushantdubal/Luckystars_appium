...
@Test public class TC009_profile_detail_valid_pincode extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_valid_pincode_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify valid pincode");
		...
		String expected_text ="400051";	
		String actual_text=driver.findElement(By.id("et_pin_code")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify valid pincode");
