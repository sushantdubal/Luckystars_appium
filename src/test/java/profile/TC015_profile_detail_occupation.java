...
@Test public class TC015_profile_detail_occupation extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_occupation_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify profile detail- Occupation");
		...
		driver.findElement(By.id("et_occupation")).click();
		String expected_text ="Skilled / Unskilled Worker";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify profile detail- Occupation");
