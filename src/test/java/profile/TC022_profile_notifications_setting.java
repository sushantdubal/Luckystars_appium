...
@Test public class TC022_profile_notifications_setting extends base_sd 
{	
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_notifications_setting_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify navigation to Notification Settings");
		...
		driver.findElement(By.id("tv_notification")).click();	
		String expected_text ="Notification Settings";	
		String actual_text=driver.findElement(By.id("tv_title")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify navigation to Notification Settings");
