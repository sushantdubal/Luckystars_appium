...
@Test public class TC013_profile_detail_marital_status_married extends base_sd 
{
	...
	@Test()
	public void profile_detail_marital_status_married_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify marital status- Married");
		...
		driver.findElement(By.id("rb_married")).click();
		
		String expected_text ="Married";	
		String actual_text=driver.findElement(By.id("rb_married")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify marital status- Married");
