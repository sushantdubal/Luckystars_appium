...
@Test public class TC019_profile_detail_marital_status_single extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void profile_detail_marital_status_single_test() throws InterruptedException 
	{
		test = report.startTest("Profile: Verify marital status- Single");
		...
		driver.findElement(By.id("rb_single")).click();
		
		String expected_text ="Single";	
		String actual_text=driver.findElement(By.id("rb_single")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Profile: Verify marital status- Single");
