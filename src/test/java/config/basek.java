...
public class basek 
{
	...
	public void precondition() throws MalformedURLException, InterruptedException
	{
		...
		capabilities.setCapability("deviceName", config.constants.kDevice);
		//Set apk path
		capabilities.setCapability("app", config.constants.kg_Path_apk);
	...
	public void startReport(){
		...
		report=new ExtentReports("/Users/apple/luckystars_android/Luckystars_android/Extent Report output_K/draw_report.html",false);
	  //report=new ExtentReports("/Users/apple/luckystars_android/Luckystars_android/Luckystars Automation Testing Report.html", false);
