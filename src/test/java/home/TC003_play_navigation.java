...
@Test public class TC003_play_navigation extends base_sd 
{
	...
	@Test()
	public void play_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to play screen");
		...
		//Click play
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout[3]")).click();
		
		test.log(LogStatus.INFO, "Clicked play icon");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to play screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to play screen");
