...
@Test public class TC004_earn_navigation extends base_sd 
{
	...
	@Test()
	public void earn_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to earns screen");
		...
		String expected_text ="Earn";	
		String actual_text=driver.findElement(By.id("in.interactive.luckystars:id/tv_titles")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to earns screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to earns screen");
