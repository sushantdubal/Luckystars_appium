...
@Test public class TC005_buy_coins_navigation extends base_sd 
{
	...
	{
		test = report.startTest("Home: Verify navigation to buy coins screen");
		...
		//wait time 10 seconds
		 Thread.sleep(10000); 
		//click coins
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[5]")).click();
		
		test.log(LogStatus.INFO, "Clicked buy coins icon");
		String expected_text ="Buy For ₹ 3,000";	
		String actual_text=driver.findElement(By.id("in.interactive.luckystars:id/tv_price")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to buy coins screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to buy coins screen");
