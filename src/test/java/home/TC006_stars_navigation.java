...
@Test public class TC006_stars_navigation extends base_sd 
{
	...
	@Test()
	public void stars_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to stars screen");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to stars screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to stars screen");
