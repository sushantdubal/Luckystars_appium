...
@Test public class TC002_winners_navigation extends base_sd 
{
	...
	@Test()
	public void winners_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to winners screen");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to winners screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to winners screen");
