...
@Test public class TC008_coins_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	@Test()
	public void coins_navigation_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify navigation to coins screen");
		...
		String expected_text ="Coins Purchase History";	
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to coins screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to coins screen");
