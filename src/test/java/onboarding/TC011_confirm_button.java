...
public class TC011_confirm_button extends base_sd
{
	...
	@Test(description="This TC will perform click on Terms and condition button")
	public void confirm_button_test() throws InterruptedException 
	{
		test=report.startTest("On Boarding: Verify button- Confirm");
		...
		String expected_text="Confirm";	
		String actual_text=driver.findElement(By.id("button1")).getText();
