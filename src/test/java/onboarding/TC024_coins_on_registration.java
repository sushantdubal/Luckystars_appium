...
public class TC024_coins_on_registration extends base_sd
{
	...
	@Test()
	public void coins_on_registration_test() throws InterruptedException 
	{	
		...
		test.log(LogStatus.INFO, "Enterd Mobile number- 9619633551");
		...
		driver.findElement(By.id("android:id/button1")).click();
		test.log(LogStatus.INFO, "User registred");
		String expected_text="10";	
		String actual_text=driver.findElement(By.id("in.interactive.luckystars:id/tv_coin_cnt")).getText();
