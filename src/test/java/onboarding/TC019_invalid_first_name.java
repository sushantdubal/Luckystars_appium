...
public class TC019_invalid_first_name extends base_sd
{
	...
	@Test()
	public void invalid_first_name_test() throws InterruptedException 
	{	
		test=report.startTest("On Boarding: Verify registration with invalid firstname");
		...
		driver.findElement(By.id("in.interactive.luckystars:id/et_first_name")).sendKeys("P");
		...
		String expected_text="Invalid First Name";	
