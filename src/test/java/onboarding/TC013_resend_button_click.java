...
public class TC013_resend_button_click extends base_sd 
{
	...
	@Test(description="This TC will perform resend button click")
	public void resend_button_click_Test() throws InterruptedException 
	{
		test = report.startTest("On Boarding: Verify button- resend button");
