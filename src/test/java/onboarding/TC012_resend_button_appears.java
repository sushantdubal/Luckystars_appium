...
public class TC012_resend_button_appears extends base_sd 
{
	...
	public void resend_button_appears_Test() throws InterruptedException 
	{
		test = report.startTest("On Boarding: Verify button- resend button appears");
