...
public class TC016_invalid_OTP_alert_pop_up extends base_sd 
{
	...
	public void invalid_OTP_alert_pop_up_Test() throws InterruptedException 
	{
		test = report.startTest("On boarding: Verify invalid OTP");
		...
		driver.findElement(By.id("in.interactive.luckystars:id/pin_layout")).sendKeys("555555");
		//Click continue button
		driver.findElement(By.id("in.interactive.luckystars:id/btn_resend")).click();
		String expected_text="Ok";	
		String actual_text=driver.findElement(By.id("android:id/button1")).getText();
