...
public class TC020_invalid_last_name extends base_sd
{
	...
	@Test()
	public void invalid_last_name_test() throws InterruptedException 
	{	
		test=report.startTest("On Boarding: Verify registration with invalid laststname");
		...
		driver.findElement(By.id("in.interactive.luckystars:id/et_last_name")).sendKeys("K");
		...
		driver.findElement(By.id("android:id/button1")).click();
		String expected_text="Invalid Last Name";	
