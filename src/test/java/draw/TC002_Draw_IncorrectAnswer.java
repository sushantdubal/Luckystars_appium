...
public class TC002_Draw_IncorrectAnswer extends basek
{
	

String version;
String inCorrectAnswertrim;
String inCorrectAnswer = "Oops.";

String inCorrectAnswertrim1;
...
public void signIn() throws InterruptedException
{
	...
	test=report.startTest("Draw - Verify Draw participation with inCorrect answer working");
...
public void partcipateDraw() throws InterruptedException
{
	...
	System.out.println("Select incorrect answer manually within 5 Secs");
	
	Thread.sleep(5000);
	inCorrectAnswertrim = driver.findElement(By.id("android:id/message")).getText().substring(0, 5);
	
	if(inCorrectAnswertrim.equalsIgnoreCase(inCorrectAnswer) || inCorrectAnswertrim.equalsIgnoreCase(inCorrectAnswer1))
	{
