...
public class TC006_filter_UniqueBids extends basek
{
	String version;
	...
	public void signIn() throws InterruptedException
	{
		...
		test=report.startTest("Bids - Verify filter_UniqueBids section working");
	...
	@Test(priority=2)
	public void filter_UniqueBids() throws MalformedURLException, InterruptedException
	{
		...
		driver.findElement(By.id("in.interactive.luckystars:id/ct_unique")).click();
		driver.navigate().back();
		...
		System.out.println("Unique Bids list viewed successfully");
