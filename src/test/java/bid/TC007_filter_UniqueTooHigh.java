...
public class TC007_filter_UniqueTooHigh extends basek
{
	String version;
	...
	public void signIn() throws InterruptedException
	{
		...
		test=report.startTest("Bids - Verify filter_uniqueTooHigh section working");
	...
	@Test(priority =2)
	public void filter_uniqueTooHigh() throws MalformedURLException, InterruptedException
	{
		...
		driver.findElement(By.id("in.interactive.luckystars:id/ct_unique_to_high")).click();
		driver.navigate().back();
		...
		System.out.println("Unique, Too High Bids list viewed successfully");
