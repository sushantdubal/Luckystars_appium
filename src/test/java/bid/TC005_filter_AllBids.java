...
public class TC005_filter_AllBids extends basek
{
	String version;
	...
	public void signIn() throws InterruptedException
	{
		...
		test=report.startTest("Bids - Verify filter_allBids section working");
	...
	public void filter_allBids()
	{
		...
		driver.findElement(By.id("in.interactive.luckystars:id/ct_all_bids")).click();
		...
		System.out.println("All bids list viewed successfully");
