...
@Test public class TC001_earn_navigation extends base_sd 
{
	@BeforeMethod
	@BeforeTest
	...
	{
		test = report.startTest("Home: Verify navigation to earn screen");
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "User navigated to earn screen");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "User not navigated to earn screen");
