...
@Test public class TC003_social_links_exists extends base_sd 
{
	...
	@Test()
	public void social_links_exists_test() throws InterruptedException 
	{
		test = report.startTest("Home: Verify social links exists");
		...
		//wait time 10 seconds
		 Thread.sleep(10000); 
		//click earn
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[4]")).click();
		test.log(LogStatus.INFO, "Clicked earn icon");
		
		String expected_text ="Link Social Accounts";	
		String actual_text=driver.findElement(By.id("in.interactive.luckystars:id/tv_link_social_accounts")).getText();
		...
		if(expected_text.contentEquals(actual_text))
		{
			...
			test.log(LogStatus.INFO, "Social links exists");
		...
		else
		{
			...
			test.log(LogStatus.INFO, "Social links not exists");
